  ...
  <div class="info">
      ...
      <el-form label-width="180px" :model="info" label-position="left">
        ...
        <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g mask="url(#a)">
            ...
            />
            <path
              d="M204.376 177.504c4.005 12.515 4.005 30.035-3.084 44.908"
              stroke="#000"
              stroke-width="1.952"
              stroke-linecap="round"
            />
          ...
          />
          <path
            d="M274.46 60.366a5.006 5.006 0 1 0 0-10.012 5.006 5.006 0 0 0 0 10.012Z"
            fill="#00EADB"
          />
          <path
            d="M159.386 68.497a8.07 8.07 0 1 0 0-16.14 8.07 8.07 0 0 0 0 16.14Z"
            fill="#FE5275"
          />
          <path
            d="M190.522 87.72a5.167 5.167 0 1 0-.001-10.335 5.167 5.167 0 0 0 .001 10.335Z"
            fill="#00EADB"
          />
          <path
    ...
    <div class="initial">
      <el-form>
        <el-form-item>
          <div class="workspace">
            <el-button class="button" @click="click"
              >选择工作区 - <span>{{ filename }}</span></el-button
            >
          </div>
        </el-form-item>
        <el-form-item>
