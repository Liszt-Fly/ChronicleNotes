            ...
            <el-form label-width="180px" :model="info" label-position="left">
                ...
                <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="#FE5274" />
                    <mask id="a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="101" y="57" width="203"
                        height="203">
                        <path
                    ...
                    <g mask="url(#a)">
                        ...
                        <path d="M204.376 177.504c4.005 12.515 4.005 30.035-3.084 44.908" stroke="#000"
                            stroke-width="1.952" stroke-linecap="round" />
                    </g>
                    <path
                    ...
                    <path d="M190.522 87.72a5.167 5.167 0 1 0-.001-10.335 5.167 5.167 0 0 0 .001 10.335Z"
                        fill="#00EADB" />
                    <path
